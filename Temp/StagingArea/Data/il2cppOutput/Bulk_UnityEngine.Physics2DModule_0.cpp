...
extern const uint32_t Collision2D_t2842956331_com_FromNativeMethodDefinition_MetadataUsageId;
extern const uint32_t Collision2D_t2842956331_pinvoke_FromNativeMethodDefinition_MetadataUsageId;
...
extern "C" void Collision2D_t2842956331_marshal_pinvoke(const Collision2D_t2842956331& unmarshaled, Collision2D_t2842956331_marshaled_pinvoke& marshaled)
{
	...
	marshaled.___m_CachedContactPoints_7 = unmarshaled.get_m_CachedContactPoints_7();
	if (unmarshaled.get_m_LegacyContactArray_8() != NULL)
	{
		il2cpp_array_size_t _unmarshaled_m_LegacyContactArray_Length = (unmarshaled.get_m_LegacyContactArray_8())->max_length;
		marshaled.___m_LegacyContactArray_8 = il2cpp_codegen_marshal_allocate_array<ContactPoint2D_t3390240644 >(_unmarshaled_m_LegacyContactArray_Length);
		for (int32_t i = 0; i < ARRAY_LENGTH_AS_INT32(_unmarshaled_m_LegacyContactArray_Length); i++)
		{
			(marshaled.___m_LegacyContactArray_8)[i] = (unmarshaled.get_m_LegacyContactArray_8())->GetAtUnchecked(static_cast<il2cpp_array_size_t>(i));
		}
	}
	else
	{
		marshaled.___m_LegacyContactArray_8 = NULL;
	}
}
extern "C" void Collision2D_t2842956331_marshal_pinvoke_back(const Collision2D_t2842956331_marshaled_pinvoke& marshaled, Collision2D_t2842956331& unmarshaled)
{
	...
	{
		il2cpp_codegen_initialize_method (Collision2D_t2842956331_pinvoke_FromNativeMethodDefinition_MetadataUsageId);
	...
	Vector2_t2156229523  unmarshaled_m_RelativeVelocity_temp_4;
	...
	CachedContactPoints2D_t2523437281  unmarshaled_m_CachedContactPoints_temp_7;
	memset(&unmarshaled_m_CachedContactPoints_temp_7, 0, sizeof(unmarshaled_m_CachedContactPoints_temp_7));
	unmarshaled_m_CachedContactPoints_temp_7 = marshaled.___m_CachedContactPoints_7;
	unmarshaled.set_m_CachedContactPoints_7(unmarshaled_m_CachedContactPoints_temp_7);
	if (marshaled.___m_LegacyContactArray_8 != NULL)
	{
		if (unmarshaled.get_m_LegacyContactArray_8() == NULL)
		{
			unmarshaled.set_m_LegacyContactArray_8(reinterpret_cast<ContactPoint2DU5BU5D_t96683501*>(SZArrayNew(ContactPoint2DU5BU5D_t96683501_il2cpp_TypeInfo_var, 1)));
		}
		il2cpp_array_size_t _arrayLength = (unmarshaled.get_m_LegacyContactArray_8())->max_length;
		for (int32_t i = 0; i < ARRAY_LENGTH_AS_INT32(_arrayLength); i++)
		{
			(unmarshaled.get_m_LegacyContactArray_8())->SetAtUnchecked(static_cast<il2cpp_array_size_t>(i), (marshaled.___m_LegacyContactArray_8)[i]);
		}
	}
}
...
extern "C" void Collision2D_t2842956331_marshal_pinvoke_cleanup(Collision2D_t2842956331_marshaled_pinvoke& marshaled)
{
	if (marshaled.___m_LegacyContactArray_8 != NULL)
	{
		il2cpp_codegen_marshal_free(marshaled.___m_LegacyContactArray_8);
		marshaled.___m_LegacyContactArray_8 = NULL;
	}
}
// Conversion methods for marshalling of: UnityEngine.Collision2D
...
extern "C" void Collision2D_t2842956331_marshal_com_back(const Collision2D_t2842956331_marshaled_com& marshaled, Collision2D_t2842956331& unmarshaled)
{
	...
	if (!s_Il2CppMethodInitialized)
	{
		il2cpp_codegen_initialize_method (Collision2D_t2842956331_com_FromNativeMethodDefinition_MetadataUsageId);
		s_Il2CppMethodInitialized = true;
	}
	int32_t unmarshaled_m_Collider_temp_0 = 0;
	unmarshaled_m_Collider_temp_0 = marshaled.___m_Collider_0;
...
extern "C" IL2CPP_METHOD_ATTR bool RaycastHit2D_op_Implicit_m653385179 (RuntimeObject * __this /* static, unused */, RaycastHit2D_t2279581989  ___hit0, const RuntimeMethod* method)
{
	static bool s_Il2CppMethodInitialized;
	if (!s_Il2CppMethodInitialized)
	{
	...
	bool V_0 = false;
	{
		Collider2D_t2806799626 * L_0 = RaycastHit2D_get_collider_m1549426026((RaycastHit2D_t2279581989 *)(&___hit0), /*hidden argument*/NULL);
		IL2CPP_RUNTIME_CLASS_INIT(Object_t631007953_il2cpp_TypeInfo_var);
...
extern "C" IL2CPP_METHOD_ATTR void Rigidbody2D_AddForce_m1113499586 (Rigidbody2D_t939494601 * __this, Vector2_t2156229523  ___force0, const RuntimeMethod* method)
{
	{
		Vector2_t2156229523  L_0 = ___force0;
		Rigidbody2D_AddForce_m1099013366(__this, L_0, 0, /*hidden argument*/NULL);
		return;
	}
}
// System.Void UnityEngine.Rigidbody2D::AddForce(UnityEngine.Vector2,UnityEngine.ForceMode2D)
